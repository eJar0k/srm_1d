...
| **BALLSStick (2″ subscale)** | high | **`raw/ballsstick_subscale_raw.csv`** | 417 | ⚠️ **RAW — needs cleaning + scaling** | See `raw/ballsstick_subscale_raw.notes.md`. **No 3″-scale firing exists.** |
