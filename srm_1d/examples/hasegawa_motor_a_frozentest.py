...
EXPERIMENTAL_TIME_OFFSET = 0.05  # align experimental ignition with sim t=0
...
def main():
    result, perf, nozzle, geo, prop = run_from_ric(
        ...
        pyrogen='bpnv',
        pyrogen_mass=9.5e-3,
        pyrogen_throat_area=14e-6,
        pyrogen_volume=4.5e-4,
        T_ignition=900.0,
        P_cutoff=0.05e6,
        k_solid=0.2058,
        t_max=5.0,
        ...
        print_interval=0.2,
        # k_solid=0.32,
        transport_path='C:/Users/ejarocki/Documents/Rocketry/Code Stuff/Erosive Burning Solver/srm_1d/srm_1d/motors/hasegawa_a.frozen.transport.yaml'
    )
